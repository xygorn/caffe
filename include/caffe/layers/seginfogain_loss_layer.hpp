#ifndef CAFFE_SEGINFOGAIN_LOSS_LAYER_HPP_
#define CAFFE_SEGINFOGAIN_LOSS_LAYER_HPP_
 ...
 *        pairs.  Computes the infogain-weighted multinomial logistic loss for a one-of-many
...
class SegInfogainLossLayer : public LossLayer<Dtype> {
 public:
   /**
    ...
    */
	 explicit SegInfogainLossLayer(const LayerParameter& param)
  ...
  virtual inline const char* type() const { return "SegInfogainLoss"; }
 ...
 protected:
  /// @copydoc SegInfogainLossLayer
  virtual void Forward_cpu(const vector<Blob<Dtype>*>& bottom,
      const vector<Blob<Dtype>*>& top);
  virtual void Forward_gpu(const vector<Blob<Dtype>*>& bottom,
      const vector<Blob<Dtype>*>& top);
  /**
   * @brief Computes the infogain-weighted softmax loss error gradient w.r.t. the predictions.
   *
...
#endif  // CAFFE_SEGINFOGAIN_LOSS_LAYER_HPP_